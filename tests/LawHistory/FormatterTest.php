...
class FormatterTest extends TestCase
{
    ...
    public function revisions()
    {
        return [
            ...
            [
                'law_id' => '123',
                'law_type' => 'Міжнародний документ',
                'law_title' => 'Про тести',
                'date' => '2000-01-01',
                'comment' => "Підписання\nНабрання чинності для України міжнародного договору",
                false,
                "Підписаний та набрав чинності для України міжнародний документ \"Про тести\""
            ],
        ];
    }
