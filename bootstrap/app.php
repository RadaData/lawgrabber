...
$app->register(LawGrabber\Proxy\ProxyServiceProvider::class);
$app->register(LawGrabber\Downloader\DownloaderServiceProvider::class);
...
$app->register(LawGrabber\History\HistoryServiceProvider::class);
